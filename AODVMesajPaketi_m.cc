...
{
    this->paketTipi = other.paketTipi;
...
void AODVMesajPaketi::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->paketTipi);
...
void AODVMesajPaketi::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->paketTipi);
    doParsimUnpacking(b,this->xEkseni);
    doParsimUnpacking(b,this->yEkseni);
}

unsigned int AODVMesajPaketi::getPaketTipi() const
{
    return this->paketTipi;
}

void AODVMesajPaketi::setPaketTipi(unsigned int paketTipi)
{
...
int AODVMesajPaketiDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='p' && strcmp(fieldName, "paketTipi")==0) return base+0;
    if (fieldName[0]=='x' && strcmp(fieldName, "xEkseni")==0) return base+1;
    if (fieldName[0]=='y' && strcmp(fieldName, "yEkseni")==0) return base+2;
...
std::string AODVMesajPaketiDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    AODVMesajPaketi *pp = (AODVMesajPaketi *)object; (void)pp;
    switch (field) {
        case 0: return ulong2string(pp->getPaketTipi());
        case 1: return ulong2string(pp->getXEkseni());
        case 2: return ulong2string(pp->getYEkseni());
        default: return "";
    }
}
...
bool AODVMesajPaketiDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    AODVMesajPaketi *pp = (AODVMesajPaketi *)object; (void)pp;
    switch (field) {
        case 0: pp->setPaketTipi(string2ulong(value)); return true;
        case 1: pp->setXEkseni(string2ulong(value)); return true;
        case 2: pp->setYEkseni(string2ulong(value)); return true;
...
void AODVRREQ::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->rreq_id);
...
void AODVRREQ::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->rreq_id);
...
unsigned int AODVRREQ::getPaketTipi() const
{
    return this->paketTipi;
}

void AODVRREQ::setPaketTipi(unsigned int paketTipi)
{
    this->paketTipi = paketTipi;
}
...
unsigned int AODVRREQ::getRreq_id() const
{
    return this->rreq_id;
}

void AODVRREQ::setRreq_id(unsigned int rreq_id)
{
...
int AODVRREQDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='h' && strcmp(fieldName, "hedefAdr")==0) return base+8;
    if (fieldName[0]=='h' && strcmp(fieldName, "hedefSeqNo")==0) return base+9;
    if (fieldName[0]=='k' && strcmp(fieldName, "kaynakAdr")==0) return base+10;
    if (fieldName[0]=='k' && strcmp(fieldName, "kaynakSeqNo")==0) return base+11;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
...
std::string AODVRREQDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 8: return ulong2string(pp->getHedefAdr());
        case 9: return ulong2string(pp->getHedefSeqNo());
        case 10: return ulong2string(pp->getKaynakAdr());
        case 11: return ulong2string(pp->getKaynakSeqNo());
        default: return "";
    }
}
...
bool AODVRREQDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 7: pp->setRreq_id(string2ulong(value)); return true;
        case 8: pp->setHedefAdr(string2ulong(value)); return true;
        case 9: pp->setHedefSeqNo(string2ulong(value)); return true;
        case 10: pp->setKaynakAdr(string2ulong(value)); return true;
        case 11: pp->setKaynakSeqNo(string2ulong(value)); return true;
        default: return false;
    }
}
...
unsigned int AODVRREP::getPaketTipi() const
{
    return this->paketTipi;
}

void AODVRREP::setPaketTipi(unsigned int paketTipi)
{
    this->paketTipi = paketTipi;
}
...
int AODVRREPDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='h' && strcmp(fieldName, "hedefAdr")==0) return base+5;
    if (fieldName[0]=='h' && strcmp(fieldName, "hedefSeqNo")==0) return base+6;
    if (fieldName[0]=='k' && strcmp(fieldName, "kaynakAdr")==0) return base+7;
    if (fieldName[0]=='k' && strcmp(fieldName, "kaynakSeqNo")==0) return base+8;
...
std::string AODVRREPDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 5: return ulong2string(pp->getHedefAdr());
        case 6: return ulong2string(pp->getHedefSeqNo());
        case 7: return ulong2string(pp->getKaynakAdr());
        case 8: return ulong2string(pp->getKaynakSeqNo());
...
bool AODVRREPDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 5: pp->setHedefAdr(string2ulong(value)); return true;
        case 6: pp->setHedefSeqNo(string2ulong(value)); return true;
        case 7: pp->setKaynakAdr(string2ulong(value)); return true;
        case 8: pp->setKaynakSeqNo(string2ulong(value)); return true;
...
unsigned int AODVRERR::getPaketTipi() const
{
    return this->paketTipi;
}

void AODVRERR::setPaketTipi(unsigned int paketTipi)
{
    this->paketTipi = paketTipi;
}
...
int AODVRERRDescriptor::findField(const char *fieldName) const
{
    ...
    int base = basedesc ? basedesc->getFieldCount() : 0;
    if (fieldName[0]=='p' && strcmp(fieldName, "paketTipi")==0) return base+0;
    if (fieldName[0]=='h' && strcmp(fieldName, "hataliDugumler")==0) return base+1;
    if (fieldName[0]=='h' && strcmp(fieldName, "hataliDugumlerSeqNo")==0) return base+2;
    if (fieldName[0]=='n' && strcmp(fieldName, "noDeleteFlag")==0) return base+3;
    if (fieldName[0]=='d' && strcmp(fieldName, "destCount")==0) return base+4;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
...
int AODVRERRDescriptor::getFieldArraySize(void *object, int field) const
{
    ...
    switch (field) {
        case 1: return pp->getHataliDugumlerArraySize();
        case 2: return pp->getHataliDugumlerSeqNoArraySize();
        default: return 0;
    }
}
...
std::string AODVRERRDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        case 0: return ulong2string(pp->getPaketTipi());
        case 1: return long2string(pp->getHataliDugumler(i));
        case 2: return long2string(pp->getHataliDugumlerSeqNo(i));
        case 3: return bool2string(pp->getNoDeleteFlag());
        case 4: return ulong2string(pp->getDestCount());
        default: return "";
    }
}
...
bool AODVRERRDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        case 0: pp->setPaketTipi(string2ulong(value)); return true;
        case 1: pp->setHataliDugumler(i,string2long(value)); return true;
        case 2: pp->setHataliDugumlerSeqNo(i,string2long(value)); return true;
        case 3: pp->setNoDeleteFlag(string2bool(value)); return true;
        case 4: pp->setDestCount(string2ulong(value)); return true;
        default: return false;
    }
}
...
unsigned int AODVRREP_ACK::getPaketTipi() const
{
    return this->paketTipi;
}

void AODVRREP_ACK::setPaketTipi(unsigned int paketTipi)
{
    this->paketTipi = paketTipi;
}
